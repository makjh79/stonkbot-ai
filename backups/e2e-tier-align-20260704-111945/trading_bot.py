...
from readiness_score import ENTRY_READINESS_MIN, ENTRY_MIN_CONFIRMATIONS
...
class STONKAIBot:
    ...
    def _is_entry_eligible_for_mode(self, sig: dict) -> bool:
        ...
        return tier == "STRONG_NOW" and readiness >= ENTRY_READINESS_MIN and conf >= ENTRY_MIN_CONFIRMATIONS and above_ema
